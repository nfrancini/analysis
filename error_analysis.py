...
for fname in path_filenames:
    ...
    output_file.write(str(J) + '\t')                        # COLONNA 2
    output_file.write(str(K) + '\t')                        # COLONNA 3
    output_file.write(str(np.mean(ene_sp)) + '\t')          # COLONNA 4
    output_file.write(str(np.mean(err_ene_sp)) + '\t')      # COLONNA 5
    output_file.write(str(np.mean(ene_g)) + '\t')           # COLONNA 6
    output_file.write(str(np.mean(err_ene_g)) + '\t')       # COLONNA 7
    output_file.write(str(np.mean(ene_dens)) +'\t')         # COLONNA 8
    output_file.write(str(np.mean(err_ene)) + '\t')         # COLONNA 9
    output_file.write(str(np.mean(susc)) + '\t')            # COLONNA 10
    output_file.write(str(np.mean(err_susc)) + '\t')        # COLONNA 11
    output_file.write(str(np.mean(G_pm)) + '\t')            # COLONNA 12
    output_file.write(str(np.mean(err_G_pm)) + '\t')        # COLONNA 13
    output_file.write(str(specific_heat(ene_dens)) + '\t')  # COLONNA 14
    output_file.write(str(np.mean(err_spec_heat)) +'\t')    # COLONNA 15
